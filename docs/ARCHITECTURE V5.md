...
query_mode:     overview | specific | comparison | process | qualification
confidence:
  intent:       float  # 0..1
  topic:        float
...
**Принципы:**
- 5 query_mode, не больше. Эмоции, темы (боль/гарантия/материалы) — НЕ query_mode, они живут в контенте/тегах.
